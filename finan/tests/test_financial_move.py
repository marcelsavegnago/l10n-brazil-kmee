...
from openerp.addons.finan.tests.financial_test_classes import \
    FinancialTestCase
...
class ManualFinancialProcess(FinancialTestCase):
    ...
    def setUp(self):
        self.financial_model = self.env['finan.lancamento']
    ...
    def test_01_check_return_views(self):
        ...
        # test for  len(finan.lancamento) == 1
        ...
        self.assertEqual(
            ...
            'finan.lancamento.divida.a.receber.form')
        self.assertEqual(
        ...
        self.assertEqual(
            action.get('display_name'),
            'finan.lancamento.divida.a.pagar.form')
        self.assertEqual(
            action.get('res_id'), financial_move_id.id)
