...
=======
        ...
        #     #  a cancelled one:
        #     # move.post()
>>>>>>> cceb051... [FIX] Ajustes para permitir digitar a NF de entrada para o Reinf (somente não deixa rodar partes que dão problema, não as corrige)
...
=======
            'inss_base': base,
            'inss_wh_value': valor,
>>>>>>> e7d0b42... [ADD] Adicionado campo de Redutor da Base de Cálculo de Retenção de INSS
        }
        return result
