...
class SpedMontaAnexo(models.TransientModel):
    _name = b'sped.monta.anexo'
    ...
    @api.multi
    def monta_anexo_compactado(self, record_ids=None):
        '''

        Este método tem por objetivo, ao receber uma lista de records contendo
        anexos, ou uma lista de anexos (ir.attachments), compactar tais anexos
        e retorná-los como um novo anexo único.
